...
#Region " Variables "
    ...
    " <br><span style=""font-family:Arial;font-size:8px;margin-top:-5px;position:relative;padding-right:5px;""> {0} ( {1} )</span><img src=""file:///{2}"" style=""width:54px; height:29px;""><span style=""font-family:Arial;font-size:8px;margin-top:-5px;position:relative;padding-left:5px;"" /> {3} ( {4} )</span> <br>" & _
     Environment.NewLine & Environment.NewLine
